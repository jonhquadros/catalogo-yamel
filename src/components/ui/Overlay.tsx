...
export function Dialog({ isOpen, onClose, title, children, id }: DialogProps) {
  useEffect(() => {
    if (isOpen) {
      ...
      {isOpen && (
        <div id={id} className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-md bg-white border border-slate-100 rounded-xl shadow-xl z-10 overflow-hidden"
          >
            {/* Header */}
